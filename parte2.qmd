...
En esta práctica utilizaremos conceptos de regresión lineal y regresión logística que ya han estudiado previamente. Antes de comenzar, recuerden algunas ideas fundamentales.
...
::: diapositivas-body
[Ver diapositivas Regresión Polinomial](https://github.com/CursosENESJuriquilla/TS_Aprendizaje_de_Maquina_2027-1/blob/main/Material/2.1-2.2_Regresion_Polinomial.pdf)
:::
:::::
...
3.  **Regresión logística.** Si $Y\in\{0,1\}$, ¿por qué no utilizamosdirectamente una regresión lineal para modelar $P(Y=1\mid X=x)$? ¿Qué transformación de la probabilidad utilizamos en regresión logística?
...
1.  ¿Qué característica de los datos no puede capturar el modelo de grado 1?
...
- grado 1 vs. grado 2 pregunta si necesitamos incorporar curvatura cuadrática;
...
4.  repetiremos el procedimiento hasta utilizar cada partición como conjunto de validación;
...
intentaría llamar al objeto `PolynomialFeatures` como si fuera la función de `ISLP`, produciendo un error.
:::
